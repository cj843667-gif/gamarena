    ...
    <div className="container mx-auto px-4 py-20 max-w-4xl mb-20">
      ...
      <div className="bg-primary-light border border-white/10 rounded-[2rem] p-10 md:p-16 space-y-12 text-gray-400 leading-loose">
        <section>
          ...
          <p>
            At GamArena, we take your privacy seriously. This Privacy Policy describes how we collect, use, and protect your information when you visit our website. Our primary goal is to provide a safe and transparent gaming environment.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Because GamArena does not require registration or login, we do not collect:
          </p>
        ...
        <section>
          ...
          <p>
            If you have any questions about this Privacy Policy, please contact us at aarifalam786@gmail.com.
          </p>
        </section>
      </div>
    </div>
